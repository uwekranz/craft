...
public class SnakeLocationTest {
	...
	public void theSnakeHeadsVerticalCoordinateIsZeroAfterItHasMovedRightOnce() {
		snake.move(RIGHT);
		locationAsserter.assertThatTheSnakeHeadsLocation(hasValue(0), onIts(VERTICAL_AXIS));
	}

	@Test
	public void theSnakeHeadsHorizontalCoordinateIsTenAfterItHasMovedRightOnce() {
		snake.move(RIGHT);
		locationAsserter.assertThatTheSnakeHeadsLocation(hasValue(10), onIts(HORIZONTAL_AXIS));
	}
	...
	public void theSnakeHeadsHorizontalCoordinateIsTwentyAfterItHasMovedRightTwice() {
		snake.move(RIGHT);
		snake.move(RIGHT);
		locationAsserter.assertThatTheSnakeHeadsLocation(hasValue(20), onIts(HORIZONTAL_AXIS));
	}
	...
	public void theSnakeHeadsVerticalCoordinateIsZeroAfterItHasMovedDownOnce() {
		...
		locationAsserter.assertThatTheSnakeHeadsLocation(hasValue(10), onIts(VERTICAL_AXIS));
	}

	@Test
	public void theSnakeHeadsHorizontalCoordinateIsZeroAfterItHasMovedDownOnce() {
		snake.move(DOWN);
		locationAsserter.assertThatTheSnakeHeadsLocation(hasValue(0), onIts(HORIZONTAL_AXIS));
	}
	...
	public void theSnakeHeadsVerticalCoordinateIsTwentyAfterItHasMovedRightTwice() {
		snake.move(DOWN);
		snake.move(DOWN);
		locationAsserter.assertThatTheSnakeHeadsLocation(hasValue(20), onIts(VERTICAL_AXIS));
	}
